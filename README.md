...
3 | <p dir="rtl" align="right">از وجود نویز در ropeهای مشغول که شاخه‌های مشغولی دارند، جلوگیری می‌کند. </p>
4 | <p dir="rtl" align="right">با تبدیل کردن commitهای حد واسط به یک commit تنها که می‌تواند برای گروه‌های توسعه دهنده کاربردی باشد، آن‌ها را مرتب می‌کند.</p>
